...
public class Examples {
    ...
    public void CheckValidTree_Remove() {
        assertTrue(HT.remMinEltValidator(heap, 3, heap.remMinElt()));
    }
    ...
    public void CheckInvalidTree_Remove() {
        assertFalse(HT.remMinEltValidator(heap, 3, binTree));
    }
    ...
    public void CheckEltStillPresent_Remove() {
        assertFalse(HT.remMinEltValidator(heap6, 3, binTree2));
    }
    ...
    public void CheckSomeOtherEltsNotPresent_Remove() {
        assertFalse(HT.remMinEltValidator(heap9, 7, binTree5));
    }
    ...
    public void CheckExtraneousElts_Remove() {
        assertFalse(HT.remMinEltValidator(heap13, 4, binTree7));
    }
